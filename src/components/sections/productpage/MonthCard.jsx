...
function MonthCard({ item, index, isHovered, setIsHovered, isInView }) {
  ...
  const handleMouseEnter = () => {
    ...
    if (isInView) {
      // Only scroll if the parent is in view
    ...
    >
      ...
      >
        <img
          ...
          style={{
            width: isHovered == index ? "26vw" : "18vw",
            height: isHovered == index ? "26vw" : "18vw",
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            background: "rgba(254, 248, 243, 1.00)",
            height: "1.0px",
            width: isHovered === index ? "100%" : "0%", // Dynamically calculate width based on index
            left: "0.0px",
            top: "calc(50% - 0.37890625px)",
